...
*	Class:		NandGate.js
*
*	Behavior:	This class represents the functionality of an NAND gate. The class contains
...
function NandGate(initX, initY, setName, id, setup) {
	...
	function evaluate() {
		if (plugin1Val != -1 && plugin2Val != -1) {
			var res = 1;
			if (plugin1Val == 1 && plugin2Val == 1) res = 0;
	...
	function setPlugoutWireColor() {
		if (plugin1Val == 1 && plugin2Val == 1) { plugout.setStroke("blue"); plugoutWire.setStroke("blue"); gateShape.setFill("blue"); gateShapeCircle.setFill("blue"); }
		else { plugout.setStroke("red"); plugoutWire.setStroke("red"); gateShape.setFill("red"); gateShapeCircle.setFill("red"); }
	}
}
