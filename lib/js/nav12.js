...
var navbar_content_for_page ='<div class="navbar navbar-default" id="navbar"> <!--navbar-static-top-->\
	...
	var prevChapterButtonHTML = '<div class="col-md-5 col-sm-6 col-xs-4">\
									<a href="#" onclick="prevChapArrowPage(chapObj)"><img class="prevChapArrowStyle" src="../lib/images/prev-chap-arrow.png"></a>\
								</div>';
					

	var nextChapterButtonHTML = '<div class="col-md-5 col-sm-6 col-xs-4 col-xs-offset9 pull-right">\
								<a href="#" onclick="nextArrowPage(chapObj)"><img class="nextChapArrowStyle" src="../lib/images/next-chap-arrow.png"></a>\
								</div>';
