var logoImageSrc, logoImageSrcIndex, logoId;
var screenWidth = screen.width;
	if (screenWidth < 800) {
		logoImageSrc = '../lib/images/logo_sm.png';
		logoImageSrcIndex = 'lib/images/logo_sm.png';
		logoId = 'logo_sm';
	}
	else { 
		logoImageSrc = '../lib/images/logo_lg.png';
		logoImageSrcIndex = 'lib/images/logo_lg.png';
		logoId = 'logo_lg';
	}
...
var navbar_content ='<div class="navbar navbar-default" id="navbar"> <!--navbar-static-top-->\
			<div class="container"> <!-- navbar container -->\
					...
					<div class="navbar-brand pull-left">\
						<a class="brand" href = "../../index.html"><img id="'+ logoId +'" src="' + logoImageSrcIndex + '"></a> <!--Logo in navbar -->\
					</div>\
...
var navbar_content_for_index ='<div class="navbar navbar-default" id="navbar"> <!--navbar-static-top-->\
			...
			<a href="#" onclick="nextArrowPage(pageObj)"><i id="navnextarrow" class="pull-right fa fa-chevron-right"></i></a>\
					...
					<div class="navbar-brand pull-left">\
						<a class="brand" href = "../index.html"> <img id="'+ logoId +'" src="' + logoImageSrc + '"></a> <!--Logo in navbar -->\
					</div>\
