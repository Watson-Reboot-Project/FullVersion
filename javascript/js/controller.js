function Controller(divID, chapterName, exerciseNum) {
	...
	figDiv.innerHTML = '<div id="selector" style="text-align:center"></div> \
		...
		<div id="runWalk" align="center"> \
		  <button id="fig' + divID + 'RunButton" type="button" style="color:#FFFFFF;background-color:' + green + '">Run</button> \
		  <button id="fig' + divID + 'WalkButton" type="button" style="color:#FFFFFF;background-color:' + orange + '">Walk</button> \
		</div>';
	...
	var walkButtonObj = document.getElementById("fig" + divID + "WalkButton");
	var runButtonObj = document.getElementById("fig" + divID + "RunButton");
	...
	function promptFunc(promptType, promptStr, defaultStr) {
		...
		var id = "fig" + divID + "TD" + (outputTable.rows.length - 1);
