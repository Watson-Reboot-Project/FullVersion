// Javascript file that retreives only the Chapters from the master.XML and displays them on ch_toc.html (Chapter Table of Contents)
...
// Unused code that previously retrieved only the Chapters form the everypage.XML
/*
